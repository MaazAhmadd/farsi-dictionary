    ...
    <div>
      ...
      <Container>
        <div className="common-page">
          <h1 className="common-page-title">Terms</h1>
          <div className="common-page-body">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Language Solutions Online.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Language Solutions Online, accessible from{' '}
                  <a href="http://FarsiDict.com/" rel="external nofollow noopener" target="_blank">
                    http://FarsiDict.com/
                  </a>
                </p>
              </li>
            ...
            <ul>
              <li>
                ...
                <a href="http://FarsiDict.com/terms" rel="external nofollow noopener" target="_blank">
                  http://FarsiDict.com/terms
                </a>
              </li>
            </ul>
          </div>
