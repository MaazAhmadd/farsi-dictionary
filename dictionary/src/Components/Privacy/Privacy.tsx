    ...
    <div>
      ...
      <Container>
        <div className="common-page">
          <h1 className="common-page-title">Privacy</h1>
          <div className="common-page-body">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to FarsiDict.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to FarsiDict, accessible from{' '}
            ...
            <ul>
              <li>
                ...
                <a href="http://FarsiDict.com/about-us" rel="external nofollow noopener" target="_blank">
                  http://FarsiDict.com/about-us
                </a>
              </li>
            </ul>
          </div>
